  ...
  return (
    <div className="w-full max-w-full overflow-hidden fixed top-0 left-0 h-full flex items-center justify-center font-Kodchasan bg-black">
      <div className="w-full h-full max-w-[1920px] flex justify-between">
        ...
        {showSidebar && (
          <div className="lg:hidden bg-black bg-opacity-10 backdrop-blur-lg fixed top-0 left-0 w-full h-full z-20">
            <ClickOutsideWrapper onClickOutside={() => setShowSidebar(false)}>
              <div className="w-[250px] p-[1px] bg-gradient-to-r from-[#8AD4EC99] via-[#EF96FF99] to-[#FF56A999] h-full max-h-full fixed rounded-lg flex">
                <div className="w-full h-full bg-black rounded-[inherit] p-4 flex flex-col text-white">
